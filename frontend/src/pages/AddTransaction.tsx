  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto" }}>
      ...
      <p className="text-gray-600" style={{ marginBottom: "2rem" }}>
        Isi form di bawah untuk menambahkan transaksi pembelian aset
      </p>
      ...
      <form onSubmit={handleSubmit} className="card">
        ...
        {/* File Upload */}
        <div className="form-group">
          <label className="form-label">Bukti Pembelian (Opsional)</label>
          <input
            type="file"
          ...
          >
            Format: JPG, PNG, PDF (max 5MB). Nama file otomatis:
            tanggal-timestamp
          </p>
        </div>
